...
function aiMetadataFromUpload({ title, url, sourceType, posterUrl, notes }) {
  ...
  if (has("trailer", "teaser", "official trailer")) {
    contentType = "Trailer";
    tags.push("Trailer");
    confidence += 10;
  }
  ...
  if (has("anime", "naruto", "one piece", "bleach", "dragon ball", "attack on titan", "jujutsu", "demon slayer", "my hero academia")) {
    category = "Anime";
    contentType = contentType === "Trailer" ? "Anime Trailer" : "Anime";
    genre = "Anime";
    language = "Japanese";
    country = "Japan";
    ...
    category = "Korea";
    contentType = contentType === "Episode" ? "K-Drama Episode" : "K-Drama";
    genre = "K-Drama";
    language = "Korean";
    country = "South Korea";
    ...
    category = "Turkey";
    contentType = contentType === "Episode" ? "Turkish Series Episode" : "Turkish Series";
    genre = "Drama";
    language = "Turkish";
    country = "Turkey";
    ...
    category = "India";
    contentType = "Indian Movie/Series";
    genre = "Bollywood";
    ...
    category = "Brazil";
    contentType = "Brazilian Movie/Series";
    genre = "Drama";
    language = "Portuguese";
    country = "Brazil";
    ...
    category = "Movies";
    contentType = contentType === "Trailer" ? "Movie Trailer" : "Movie";
    confidence += 15;
  }
  ...
  return {
    aiGenerated: true,
    aiVersion: "local-smart-engine-v2",
    category,
    contentType,
    genre,
    year,
