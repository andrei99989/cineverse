...
function isInvalidBulkUpload(upload) {
  ...
  const looksBulk = title.includes("bulk import") || title.includes("bulk youtube") || title.includes("bulk rumble") || title.includes("bulk tiktok");
  const hasBulkSource = ["youtube", "rumble", "tiktok", "vimeo", "dailymotion", "terabox"].some((source) => sourceType.includes(source));
