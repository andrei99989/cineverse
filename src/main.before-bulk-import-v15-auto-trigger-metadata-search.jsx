...
const CINEVERSE_BUILD = "2026.04.28-bulk-import-v14-direct-search-field-handoff";
...
function UploadPage({ uploads, addUpload, deleteUpload, updateUpload, onEdit, onInfo, onPlay, onReload }) {
  ...
  return (
    <main>
      <section className="section">
        <UploadMetadataSearch metadataSearchSeed={metadataSearchSeed} clearMetadataSearchSeed={() => setMetadataSearchSeed("")} />
        <h2><Upload size={28} /> Upload cu AI metadata</h2>
        <p>AI metadata poate fi ON/OFF. Dacă îl oprești, completezi manual metadata.</p>

        <BulkImportPanel onDataChanged={onReload} onSendToMetadataSearch={setMetadataSearchSeed} />
