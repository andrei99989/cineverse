...
export default function BulkImportPanel({ onDataChanged }) {
  ...
  const handleSendToMetadataSearch = async (item) => {
    ...
    try {
      ...
      setMetadataHandoffMessage("Query copiat pentru AI Metadata Search: " + query);
    } catch {
      setMetadataHandoffMessage("Query pregătit pentru AI Metadata Search: " + query);
    }
  };
    ...
    <div className="bulkImportPanel" data-bulk-import-panel="component-v1">
      ...
      {aiQueueReport && (
        <div className="bulkAiQueueReport">
          ...
          <button type="button" className="secondary" onClick={handleProcessFirstAiMetadata} disabled={aiQueueLoading || !aiQueueReport.total}>
