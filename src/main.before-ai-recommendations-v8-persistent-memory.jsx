...
const CINEVERSE_BUILD = "2026.04.26-ai-recommendations-v7-memory";
...
function HomePage({ selectedMovie, setPage, movies, uploads, apiStatus, watchHistory = [], resetWatchHistory, onPlay, onSearchRecommendation, lastAiRecommendation }) {
      ...
      {lastAiRecommendation && (
        <section className="section">
          ...
          <div className="recommendationCard">
            <span className="pill">AI Memory</span>
