...
const CINEVERSE_BUILD = "2026.04.28-ai-library-v41-auto-test-mode";
...
function AiLibraryPage({ uploads, onPlay, onEdit, onInfo, onDelete, updateUpload }) {
  ...
  const [aiLibraryAutoTestEnabled, setAiLibraryAutoTestEnabled] = useState(false);
  ...
  useEffect(() => {
    if (!aiLibraryAutoTestEnabled || aiLibraryAutoTestRunning) return;
    runAiLibraryAutoTest();
  }, [aiLibraryAutoTestEnabled]);
              ...
              <div className="aiLibraryAutoTestBox">
                <div className="aiLibraryAutoTestHeader">
                  ...
                  <button
                    ...
                    onClick={() => setAiLibraryAutoTestEnabled(!aiLibraryAutoTestEnabled)}
                  >
                ...
                {aiLibraryAutoTestReport ? (
                  ...
                  <span className="mutedText">Auto test OFF. Când este ON, verifică automat funcțiile principale AI Library.</span>
                )}
