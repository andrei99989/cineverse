...
function App() {
  ...
  async function syncUploadsToAlgolia() {
    try {
      ...
      console.error(error);
      alert("Sync Algolia a eșuat. Verifică Worker-ul și conexiunea.");
      return null;
    }
  }
  ...
  return (
    <div className="app">
      ...
      {page === "admin" && <AdminPage movies={movies} uploads={uploads} addMovie={addMovie} deleteMovie={deleteMovie} syncUploadsToAlgolia={syncUploadsToAlgolia} />}
    </div>
  );
}
...
function AdminPage({ movies, uploads, addMovie, deleteMovie, syncUploadsToAlgolia }) {
  return (
    <main>
      <section className="section admin">
        ...
        <div className="details">
          <div>
            <span className="pill">Algolia</span>
            <h3>Sync uploads to Algolia</h3>
            <p>Indexează toate upload-urile din Cloudflare D1 în Algolia uploads.</p>
