...
const CINEVERSE_BUILD = "2026.04.27-ai-library-catalog-v2-smart-empty-state";
...
function AiLibraryPage({ uploads, onPlay, onEdit, onInfo, onDelete, updateUpload }) {
  ...
  const libraryOptions = (field) => {
    if (catalogMode && catalogFacets) {
      if (field === "category") return catalogFacets.categories || ["All"];
      if (field === "genre") return catalogFacets.genres || ["All"];
      if (field === "source") return catalogFacets.sources || ["All"];
  ...
  useEffect(() => {
    loadCatalogPage();
  }, [catalogMode, page, libraryQuery, libraryCategory, libraryGenre, librarySource, libraryQualityFilter, librarySort]);
