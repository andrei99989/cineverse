        ...
        {bulkApplyFeedback && (
          <div className="bulkApplyFeedbackBox">
            ...
            {bulkApplyFeedback.status !== "error" && (
              <span className="mutedText">AI Queue se actualizează automat.</span>
            )}
        ...
        {selectedBulkMetadataTarget && (
          <div className="bulkMetadataApplyBox">
            ...
            <button
              ...
              title={bulkApplyReadiness?.ready ? "Aplică metadata pe Bulk selectat" : "Guard-ul verifică formularul înainte de aplicare"}
            >
