...
const CINEVERSE_BUILD = "2026.04.27-ai-library-v5-filter-presets";
        ...
        <div className="details">
          <div>
            ...
            <div className="row">
              ...
              <button className="secondary" onClick={() => applyLibraryPreset("anime")}>Anime Japonia</button>
              <button className="secondary" onClick={() => applyLibraryPreset("movies")}>Filme</button>
              <button className="secondary" onClick={() => applyLibraryPreset("series")}>Seriale</button>
              <button className="secondary" onClick={() => applyLibraryPreset("bollywood")}>Bollywood</button>
              <button className="secondary" onClick={() => applyLibraryPreset("sport")}>Sport</button>
              <button className="secondary" onClick={() => applyLibraryPreset("music")}>Muzică</button>
              <button className="secondary" onClick={() => applyLibraryPreset("youtube")}>YouTube</button>
              <button className="secondary" onClick={() => applyLibraryPreset("tiktok")}>TikTok</button>
              <button className="secondary" onClick={() => applyLibraryPreset("terabox")}>Terabox</button>
            </div>
