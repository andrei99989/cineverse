...
const CINEVERSE_BUILD = "2026.04.27-ai-library-v6-smart-preset-counts";
...
function AiLibraryPage({ uploads, onPlay, onEdit, onInfo, onDelete, updateUpload }) {
  ...
  const [libraryQualityFilter, setLibraryQualityFilter] = useState("All");
  ...
  const [libraryVideoQuality, setLibraryVideoQuality] = useState("All");
  ...
  const applyLibraryPreset = (preset) => {
    ...
    if (preset === "tiktok") {
      setLibrarySource("TikTok");
      setLibraryQualityFilter("All");
      return;
    }

    if (preset === "terabox") {
      setLibrarySource("Terabox");
      setLibraryQualityFilter("All");
      return;
    }
  };
        ...
        <div className="details">
          <div>
            ...
            <div className="row">
              ...
              <button className="secondary" onClick={() => applyLibraryPreset("anime")}>Anime Japonia · {presetCount("anime")}</button>
              <button className="secondary" onClick={() => applyLibraryPreset("movies")}>Filme · {presetCount("movies")}</button>
              <button className="secondary" onClick={() => applyLibraryPreset("series")}>Seriale · {presetCount("series")}</button>
              <button className="secondary" onClick={() => applyLibraryPreset("bollywood")}>Bollywood · {presetCount("bollywood")}</button>
              <button className="secondary" onClick={() => applyLibraryPreset("sport")}>Sport · {presetCount("sport")}</button>
              <button className="secondary" onClick={() => applyLibraryPreset("music")}>Muzică · {presetCount("music")}</button>
              <button className="secondary" onClick={() => applyLibraryPreset("youtube")}>YouTube · {presetCount("youtube")}</button>
              <button className="secondary" onClick={() => applyLibraryPreset("tiktok")}>TikTok · {presetCount("tiktok")}</button>
              <button className="secondary" onClick={() => applyLibraryPreset("terabox")}>Terabox · {presetCount("terabox")}</button>
            </div>
